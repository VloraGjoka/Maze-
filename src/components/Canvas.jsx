                ...
                <div className="options">
                    <div className="firstDiv">
                        ...
                        <div className="childFirstDiv">
                            ...
                            <button className="ms-1" onClick={this.generateMaze} ref={ref => {this._generateButton = ref}}>
                                Generate maze
                            </button>    
                        </div>
                    </div>
                   ...
                   <div className="childThirdDiv">
                        ...
                        <button className="ms-1" onClick={this.solveMaze} ref={ref => {this._solveButton = ref}}>
                            Solve maze
                        </button>
                    </div>
                   </div>
